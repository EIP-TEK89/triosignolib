/**
 * Clock class to manage the clock speed and time intervals.
 * It provides methods to check if it's time to run a task,
 * get and set the clock speed, reset the clock, and get the real clock speed.
 */
export class Clock {
